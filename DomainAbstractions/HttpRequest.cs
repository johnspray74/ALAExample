...
namespace DomainAbstractions
{
    ...
    /// </summary>
    public class HttpRequest : IEvent, IDataFlow<string>
    {
        // Properties
        ...
        public Dictionary<string, string> PostContent = new Dictionary<string, string>();
        public bool JustPing = false;
        public bool SendRequestOnFlag = false;
        ...
        {
            this.URL = URL;
            UserAgent = Libraries.Constants.UserAgent;
        }
