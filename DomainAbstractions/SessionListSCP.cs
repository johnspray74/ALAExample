...
namespace DomainAbstractions
{
    ...
    /// </summary>
    public class SessionListSCP : ITableDataFlow // inputOutputTableData
    {
        // properties
        ...
        async Task ITableDataFlow.GetHeadersFromSourceAsync(object queryOperation)
        {
            ...
            // output session total count
            sessionListCount.Data = sessionFileNumber.Count.ToString();
            //sessionIndexList.Add(sessionIndexList.Count.ToString()); KL the previous version of Line74-75
